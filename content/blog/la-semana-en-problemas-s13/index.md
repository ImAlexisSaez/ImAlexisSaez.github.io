...
Discuta, según los valores reales de $a$ y $b$, el sistema siguiente y
resuélvalo cuando sea compatible determinado.
...
Una confitería de Santander es famosa por sus dos especialidades de tartas: la
...
producirse para obtener el mayor ingreso por ventas

### Ejercicio 4

Sea $n\in\mathbb{N}$. Determine todas las matrices
$A\in\mathcal{M}_2(\mathbb{R})$ tales que
